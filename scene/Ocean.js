...
{
    console.log("Ocean: Starting initialization");
    try {
        oceanMaterials.Start();
        console.log("Ocean: Materials initialized");
        ...
        surface.add(volume);
        console.log("Ocean: Volume created");
    } catch (error) {
        console.error("Ocean: Error during initialization", error);
    }
    console.log("Ocean: Initialization complete");
}
