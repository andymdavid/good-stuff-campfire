...
import { cameraForward } from "../scripts/SimplifiedScene.js";
...
{  
    console.log("OceanMaterial: Starting initialization");
    try {
        ...
        console.log("OceanMaterial: Object shader initialized");
        ...
        console.log("OceanMaterial: Triplanar shader initialized");
    } catch (error) {
        console.error("OceanMaterial: Error during initialization", error);
    }
    console.log("OceanMaterial: Initialization complete");
}